    ...
    registered_delivery_descendants = frozenset(
        {
            ...
            "src/d2t_rna/data/phase2_protocol.py",
            "src/d2t_rna/architecture/__init__.py",
            "src/d2t_rna/architecture/phase3_protocol.py",
            "src/d2t_rna/architecture/provable_bound.py",
            "scripts/t3_schemeC_run.py",
            "tests/architecture/test_provable_bound.py",
            "scripts/t3_phase3_protocol_run.py",
            "tests/architecture/test_phase3_protocol.py",
            "scripts/t2_phase2_protocol_run.py",
            "tests/data/test_phase2_protocol.py",
            ...
            "tests/audit/test_phase5_claim_register.py",
            "scripts/t5_phase5_claim_register.py",
            "tests/audit/test_claim_evidence_graph_v2.py",
            "scripts/t6_claim_evidence_graph.py",
