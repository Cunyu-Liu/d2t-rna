...
executed baselines. On a registered real RNA case (the add adenine-riboswitch aptamer, PDB 1Y26), the
...
same executable (Section~\ref{sec:real}) emits the certificate. We do \emph{not} claim an executed
certificate for a second assay without its registered data.
